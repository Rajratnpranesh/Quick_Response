...
in_file='/home/raj/mntShare/share/deep-learning-for-big-crisis-data-master/data/prccd_folder/sample.csv'

with open(r'/home/raj/mntShare/share/deep-learning-for-big-crisis-data-master/data/prccd_folder/sample.csv', 'rU') as fin:
	i=np.array([])
	X=np.array([])
	y=np.array([])
        rows = csv.reader(fin)
